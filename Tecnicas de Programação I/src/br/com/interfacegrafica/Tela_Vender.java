 ...
 * @author pedro
 */
public class Tela_Vender extends javax.swing.JFrame {

    /**
     * Creates new form Tela_Vender
     */
    public Tela_Vender() {
        initComponents();
        setTitle("Vender");        
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(tx_cod)
                        .addComponent(tx_quant)
                        .addComponent(bt_estocar, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(14, 14, 14)
    ...
    private void bt_estocarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_estocarActionPerformed
        ...
        try {
            bodega.venderProduto(tx_cod.getText(), quantidade);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Vender.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_Vender().setVisible(true);
            }
        });
    }
