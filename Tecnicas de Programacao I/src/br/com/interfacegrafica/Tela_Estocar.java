 ...
 * @author pedro
 */
public class Tela_Estocar extends javax.swing.JFrame {

    /**
     * Creates new form Tela_Estocar
     */
    public Tela_Estocar() {
        initComponents();
    }
    ...
    private void bt_estocarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_estocarActionPerformed
        ...
        bodega.estocarProduto(tx_cod.getText(), quantidade);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Estocar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_Estocar().setVisible(true);
            }
        });
    }
